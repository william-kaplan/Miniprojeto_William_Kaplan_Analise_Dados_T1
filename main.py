...
# insights observados
print('-'*14, 'Insights observados', '-'*15)
print('Qual gênero comprou mais, F ou M?')
print('Gênero que mais comprou foi o F (feminino), com um total de 382427 compras (~52%).')
print('Qual categoria foi a mais vendida?')
print('Categoria mais vendida foi a de alimentos, com uma grande diferença comparado a outras categorias.')
print('Qual classe comprou mais?')
print('Classe econômica que mais comprou foi a classe B, a que menos comprou foi a classe A, mostrando que a classes A, faz compras em períodos maiores.')
print('-'*50)

# problemas remanescentes 
print('-'*12, 'Problemas remanescentes', '-'*13)
print('O que o era o valor #N/D na categoria?')
print('Possivelmente um erro na hora de cadastrar a categoria')
print('O que eram as Colunas Unnamed?')
print('Colunas para uso futuro ou colunas que não foram utilizadas e nomeadas')
print('Tinham 96.553 duplicatas, isso é muito para uma base de 830.000 registros?')
print('Comparada com a base de dados total não é muito. Por isso a decisão de excluir esses itens duplicados')
print('-'*50)
